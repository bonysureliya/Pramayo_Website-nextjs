...
const FooterLap: React.FC<NavbarProps> = ({}) => {
  return (
    <div className="flex mt-[100px] flex-col w-[100%] h-[300px]  items-center text-[#FFF] font-sans font-medium text-[16px]">
    <div className="flex w-[100%] justify-between px-[65px] ">
      ...
      <div className="flex w-full justify-between px-[60px] mt-[60px]">
        <p className="text-[13px] text-[#FFF] font-sans">©2024 Pramayo</p>
        <p className="text-[13px] text-[#FFF] font-sans">Copyright Alright Reserved</p>
      </div>
    </div>
  );
};
