...
const AboutUsContentLap = () => {
  return (
    <section className="flex flex-col w-full px-[40px] mt-[150px] gap-24">
      <div className="flex justify-between items-start w-full ">
        <div className="w-[650px]">
          <h1 className="text-[55px] font-semibold leading-tight ">
            <span className="text-white">Specialized</span>
            <span className="text-[#E1BBFB]">Services To Bring </span>
            <span className="text-white">Your Brand To Life</span>
          </h1>
        </div>
      ...
      <div className="flex justify-between gap-8">
        <div className="h-[530px] w-[650px] relative bg-gradient-to-r from-[#060B21] via-[#0E142F] to-[#060B21] rounded-[20px] overflow-hidden">
          <Image alt="Background pattern" className="absolute w-full h-full object-cover" src={ranctagle} />
          <Image alt="UI Card" className="absolute bottom-[-40px] right-12 z-10 w-[375px] h-[375px]" src={uiImageCard} />
        ...
        <div className="flex flex-col gap-[25px]">
          {[
            ...
            <div 
              key={index} 
              className="group h-[160px] w-[540px] rounded-[20px] bg-gradient-to-r from-[#060B21] via-[#0E142F] to-[#0E142F] flex items-center justify-around p-8 relative overflow-hidden transition-all duration-300 hover:bg-[#0A0F26] cursor-pointer border border-transparent hover:border-[#E1BBFB]"
            >
              ...
              <div className="flex-[6] pl-8 relative z-10">
