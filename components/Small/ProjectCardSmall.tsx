    ...
    <div className="mt-[20px] w-full flex flex-col justify-around items-center">
      <div className="h-[80px] w-full flex flex-col justify-center items-center">
        <div className="flex gap-2">
          <p className="text-white font-sans text-[22px] font-semibold">
        ...
        <div className="flex">
          ...
          <p className="text-[#E1BBFB] font-sans text-[22px] font-semibold">
            With Strategy
          </p>
        </div>
      </div>
      <div className="flex flex-col justify-center">
        <div className="flex  flex-col">
          <p className="text-[15px] text-[#FFF] font-bold">Inside Our</p>
          <p className="text-[15px] text-[#FFF] font-bold">Creative Process</p>
        </div>
...
<div className='mt-[100px] flex flex-col justify-center items-center'>
       <div className="w-[290px] p-[15px]  flex flex-col gap-[15px] rounded-[19.7px] hover:scale-105 transition-all ease-in duration-200" style={{ background: 'linear-gradient(114deg, #060B21 75.05%, #151B36 98.29%), #FFF' }}>
        ...
        <div className="w-[290px] p-[15px] mt-[15px] flex flex-col gap-[15px] rounded-[19.7px] hover:scale-105 transition-all ease-in duration-200" style={{ background: 'linear-gradient(114deg, #060B21 75.05%, #151B36 98.29%), #FFF' }}>
